...
// With FreeType Fonts.
void font_data::print(float x, float y, float size, std::string const& text)  {
...
void font_data::print(float x, float y, const std::string &text)
{
    print(x,y,h/.63f,text);
}

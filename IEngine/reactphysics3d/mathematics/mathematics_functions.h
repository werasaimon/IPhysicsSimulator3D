...
RP3D_FORCE_INLINE decimal computePointToLineDistance(const Vector3& linePointA,
                                                     const Vector3& linePointB,
                                                     const Vector3& point)
{
...
RP3D_FORCE_INLINE Array<Vector3> clipSegmentWithPlanes(const Vector3& segA,
                                                       const Vector3& segB,

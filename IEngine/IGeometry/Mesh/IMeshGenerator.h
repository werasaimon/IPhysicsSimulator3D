...
namespace IEngine
{
    ...
    class IMeshGenerate2 : public  IMesh
    {

        public:

            //! Descriptor structure for an ellispoid (also sphere) mesh.
            IMeshGenerate2(const MeshGenerator::EllipsoidDescriptor& __descriptor_Ellipsoid__) ;
    ...
    public:
        ...
        //! Descriptor structure for a cuboid (also cube) mesh.
        IMeshGenerate(const MeshGenerator::CuboidDescriptor& __descriptor_cuboid__) ;

        //! Descriptor structure for an ellispoid (also sphere) mesh.
        IMeshGenerate(const MeshGenerator::EllipsoidDescriptor& __descriptor_Ellipsoid__) ;

        //! Descriptor structure for a cone mesh.
        IMeshGenerate(const MeshGenerator::ConeDescriptor& __descriptor_Cone__) ;

        //! Descriptor structure for a cylinder mesh.
        IMeshGenerate(const MeshGenerator::CylinderDescriptor& __descriptor_Cylinder__) ;

        //! Descriptor structure for a pie (also pie-diagram) mesh.
        IMeshGenerate(const MeshGenerator::PieDescriptor& __descriptor_Pie__) ;

        //! Descriptor structure for a pipe mesh (i.e. cylinder with a hole).
        IMeshGenerate(const MeshGenerator::PipeDescriptor& __descriptor_Pipe__) ;

        //! Descriptor structure for a capsule mesh (i.e. cylinder with a half-sphere at top and bottom).
        IMeshGenerate(const MeshGenerator::CapsuleDescriptor& __descriptor_Capsule__) ;

        //! Descriptor structure for a torus mesh.
        IMeshGenerate(const MeshGenerator::TorusDescriptor& __descriptor_Torus__) ;

        //! Descriptor structure for a torus-knot mesh (uses the curve generator).
        IMeshGenerate(const MeshGenerator::TorusKnotDescriptor& __descriptor_TorusKnot__) ;

        //! Descriptor structure for a spiral mesh.
        IMeshGenerate(const MeshGenerator::SpiralDescriptor& __descriptor_Spiral__) ;

        //! Descriptor structure for a curve mesh (as a rope along a given curve function).
        IMeshGenerate(const MeshGenerator::CurveDescriptor&  __descriptor_Curve__) ;

        //! Descriptor structure for a Bezier patch mesh.
        IMeshGenerate(const MeshGenerator::BezierPatchDescriptor& __descriptor_Bezier__) ;
    };
